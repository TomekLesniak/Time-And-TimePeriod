...
namespace Time_And_TimePeriod_Milliseconds_Lib
{
    ...
    public readonly struct TimePeriod //: IEquatable<TimePeriod>, IComparable<TimePeriod>
    {
        ...
        {
            var timeOneSeconds = timeOne.Hours * 3600 + timeOne.Minutes * 60 + timeOne.Seconds + timeOne.Milliseconds / 1000.0;
            var timeTwoSeconds = timeTwo.Hours * 3600 + timeTwo.Minutes * 60 + timeTwo.Seconds + timeTwo.Milliseconds / 1000.0;
        ...
        /// <example>123:1:23.920 is valid time period format as well</example>
